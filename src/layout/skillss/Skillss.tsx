                ...
                <FlexWrapper justify="space-between" align='center'>
                    ...
                    <WrapperBox>
                        <FlexWrapper justify="space-between" wrap="wrap">
                            <SkillssItem bottom={'40'} title={'Web design'} description={'Provide our customers with optimized user-friendly experience to increase the efficiency of digital products.'}/>
                            <SkillssItem bottom={'40'} title={'Mobile design'} description={'Mobile application development is a highlight that businesses are interested in at the moment and in the future.'}/>
                            <SkillssItem bottom={'40'} title={'Branding'} description={'Understanding the business and their target customers, I’m the bridges to bring the brand closer to their clients.'}/>
                            <SkillssItem bottom={'40'} title={'3D Modeling'} description={'Help you translate your existing design or concept into CAD or to work with you to develop the ideal design. 3D Models great for modern digital art'}/>
